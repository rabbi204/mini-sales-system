    ...
    <div class="container">
        <div class="row">
                                            ...
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name">
                                                            <a href="{{ url('product/details/'. $product -> id .'/'.$product -> product_slug_en) }}"> @if (session() -> get('language') == 'bangla') {{ $product -> product_name_bn }}  @else {{ $product -> product_name_en }} @endif</a>
                                                        </h3>
                                            ...
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        ...
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span class="price"> {{ $product -> selling_price }} TK</span></div>
                                                        <!-- /.product-price -->
                                                    </div>
                                                </div>
                                                <!-- /.col -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                            ...
                            <div class="container-fluid">
                                <div class="caption bg-color vertical-center text-left">
                                    <div class="big-text fadeInDown-1">
                                        @if (session() -> get('language') == 'bangla') {{ $slider -> slider_title_bn }} @else {{ $slider -> slider_title_en }} @endif
                                    </div>
                                    <div class="excerpt fadeInDown-2 hidden-xs"><span>
                                        @if (session() -> get('language') == 'bangla') {{ $slider -> slider_desc_bn }} @else {{ $slider -> slider_desc_en }} @endif
                                        </span>
                                    </div>
                    ...
                    <div class="more-info-tab clearfix">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a data-transition-type="backSlide" href="#category{{ $category -> id }}" data-toggle="tab">
                                @if (session() -> get('language') == 'bangla') {{ $category -> category_name_bn }} @else {{ $category -> category_name_en }} @endif</a></a>
                            </li>
                            @endforeach
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    @if ($product -> discount_price == NULL )
                                                        <div class="product-price"><span class="price">{{ $product -> selling_price }} Taka</span></div>
                                                        @else
                                                        <div class="product-price"><span class="price">{{ $product -> discount_price }} Taka</span> <span class="price-before-discount">{{ $product -> selling_price }} Taka</span></div>
                                                    @endif
                                                    <!-- /.product-price -->
                                                </div>
                                                <!-- /.product-info -->
                ...
                <!-- /.section -->
                <!-- =========================== SKIPP PRODUCTS-0 : END ========================= -->


                 <!-- ============================================== SKIP PRODUCTS-1 :Started ============================================== -->
                 <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                ...
                <!-- ============================= SKIP BRAND PRODUCTS-0 :Started ===================== -->
                 <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session() -> get('language') == 'bangla') {{ $skip_brand_0 -> brand_name_bn }}  @else {{ $skip_brand_0 -> brand_name_en }} @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <!-- /.section -->
                <!-- =========================== SKIPP BRAND PRODUCTS-0 : END ========================= -->


                <!-- ============================= SKIP BRAND PRODUCTS-1 :Started ===================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
