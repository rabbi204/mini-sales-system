                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card" style="width: 18rem;">
                            <img src="" id="pimage" class="card-img-top" width="200px" height="200px" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <ul class="list-group">
                            <li class="list-group-item">Product Price: <strong class="text-danger"><span id="pprice"></span>tk</strong><del id="oldprice"></del></li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="1" min="1" id="qty" class="form-control">
                        </div><!-- form group ended--->
               ...
               $.each(response.carts, function(key,value){
                 ...
                 <div class="row">
                   ...
                   <div class="col-xs-7">
                     ...
                     <div class="price">${value.price} tk</div>
                   </div>
                   <div class="col-xs-1 action"> <button type="submit" id="${value.rowId}" onclick="miniCartRemove(this.id)" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button> </div>
                 </div>
               </div>
               <!-- /.cart-item -->
                ...
                $.each(response, function (key, value) {
                    rows += `<tr>
                                ...
                                <td class="col-md-1 close-btn">
                                    <button type="submit" id="${value.id}" onclick="wishlistRemove(this.id)" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                </td>
                            </tr>`;
                });
            ...
            success: function (response) {
                ...
                $.each(response.carts, function (key, value) {
                    rows += `<tr>
                                ...
                                <td class="col-md-2">
                                    <strong>${value.subtotal} tk</strong>
                                </td>
                                <td class="col-md-1 close-btn">
